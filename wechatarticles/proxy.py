...
import ssl
from ssl import SSLError, SSLContext, PROTOCOL_TLS_SERVER, PROTOCOL_TLS_CLIENT
...
class ProxyHandle(BaseHTTPRequestHandler):
    ...
    def connect_intercept(self):
        ...
        try:
            ...
            context = ssl.SSLContext(PROTOCOL_TLS_SERVER)
            ...
            self.send_error(500, "SSL Certificate Error")
            return
        except Exception as e:
